...
class PodspecTask extends DefaultTask {
    ...
    void podspecWrite() {
        ...
        String resourceIncludePath = Utils.relativizeNonParent(getDestPodspecDirFile(),
                getDestSrcMainResourcesDirFile())
        // iOS packed libraries are shared with watchOS
        String libDirIosDebug = Utils.relativizeNonParent(getDestPodspecDirFile(), new File(getDestLibDirFile(),
                'iosDebug'))
        String libDirIosRelease = Utils.relativizeNonParent(getDestPodspecDirFile(), new File(getDestLibDirFile(),
                'iosRelease'))
        String libDirOsxDebug = Utils.relativizeNonParent(getDestPodspecDirFile(), new File(getDestLibDirFile(),
                'x86_64Debug'))
        String libDirOsxRelease = Utils.relativizeNonParent(getDestPodspecDirFile(), new File(getDestLibDirFile(),
                'x86_64Release'))
